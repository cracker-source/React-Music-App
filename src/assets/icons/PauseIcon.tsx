...
const PauseIcon = ({ onClick }: PauseIconProps) => {
    return (
        <svg onClick={onClick} className='w-8 md:w-12 cursor-pointer' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 300.003 300.003" xmlSpace="preserve">
            <g>
                <g>
                    <path fill='white' d="M150.001,0c-82.838,0-150,67.159-150,150c0,82.838,67.162,150.003,150,150.003c82.843,0,150-67.165,150-150.003
