...
const VideoCardIcon = () => {
    return (
        <svg className='w-5 h-5' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <path fill="#A81411" d="M384.857,170.339c-7.677,2.343-15.682,4.356-23.699,6.361
	...
	C302.947,255.602,302.904,259.019,300.494,260.167L300.494,260.167z"/>
            <path fill="#D1D1D1" d="M341.649,152.333h-87.373v78.605l46.287,23.455c2.384,1.208,2.341,4.624-0.069,5.773l-46.218,22.044
