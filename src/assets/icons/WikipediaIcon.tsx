...
const Wikipedia = () => {
    return (
        <svg className='w-5 h-5' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 26 26" xmlSpace="preserve">
            <g>
                <path fill="white" d="M21.125,0H4.875C2.182,0,0,2.182,0,4.875v16.25C0,23.818,2.182,26,4.875,26h16.25
