...
const ShuffleIcon = ({ shuffle, onClick }: ShuffleIconProps) => {
    return (
        <svg onClick={onClick} fill={`${shuffle === PlayerOptions.Shuffle ? 'white' : 'gray'}`} className='w-3 h-3 md:w-4 md:h-4 cursor-pointer' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 230.055 230.055" xmlSpace="preserve">
